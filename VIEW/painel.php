...
<body>
    <div class="p-3 mb-2 bg-dark text-white mb-3">
        ...
        <div class="d-flex flex-row-reverse">
            <div class="p-2">
                <a class="btn btn-danger" href="../CONTROLLER/logout.php"><i class="bi bi-box-arrow-left"></i> Sair</a>
            </div>
        </div>
            ...
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../CONTROLLER/funcionarios.php" class="btn btn-primary"><i class="bi bi-table"></i> Abrir</a>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../CONTROLLER/bebibas.php" class="btn btn-primary"><i class="bi bi-table"></i> Abrir</a>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../CONTROLLER/clientes.php" class="btn btn-primary"><i class="bi bi-table"></i> Abrir</a>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../CONTROLLER/artistas.php" class="btn btn-primary"><i class="bi bi-table"></i> Abrir</a>
                    </div>
                </div>
            </div>
        </div>
